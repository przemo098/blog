...
export const CvData: IWorkUnit[] = [
  {
    jobTitle: "Consultant",
    description: "eDoc (automation of document management system, time saving and reducing costs of staff) – full stack\n" +
    ...
    techStack: "React, Hooks & Saga, Formik, Typescript, Visual Studio Code, ASP.NET, EntityFramework, SSMS, Rider,\n" +
  ...
  },
  {
    ...
    description: "Full stack architect and team leader\n" +
      ...
      "providing solutions,",
    techStack: "ASP.NET core 3, Angular 9, SQL server, EF, Azure, Docker, Nginx, Java, Spring Boot\n" +
  ...
  },
  {
    ...
    description: "FRTB CVA (Fundamental Review of the Trading Book) – Basel III implementation, government directive,\n" +
    ...
    techStack: "React, Typescript, RxJs, ASP.NET, SQL server, EntityFramework Primo Grid (internal grid),\n" +
      "TFS (Repos, Boards, Test Plans)"
  },
  {
    placeWithDate: "Bank for International Settlements (07.2018 – 03.2019)",
    jobTitle: " Full stack developer",
    description: "Switzerland – Confidential (Security systems, ERP, DataHubs), adding enhancements for existing\n" +
      "workflows e.g. access / document management etc., as far as creating brand new flows with UI",
    techStack: "C#, ASP.NET web api, Microsoft workflow foundation, React, Angular 1.6 and 6-7, Quartz,\n" +
...
{
    placeWithDate: "The Bank of New York Mellon Corporation (01.2018 – 07.2018)",
    jobTitle: "Specialist Developer (Vice President) ",
    description: "Green field project based on internal cloud with microservices in Docker containers",
    techStack: ".NET Core 2 , Kafka, EF core, sqlServer 2014, Xunit, Nsubstitute, Angular5, AgGrid,\n" +
  ...
  },
{
    ...
    description: "Improvement of Allexis – application responsible for sharing data, nondisclosure agreement",
    techStack: "(.NET core 2, ElasticSearch, PostgreSql, NUnit, AWS, ActiveMQ, React, CSS/HTML, NAnt)\n" +
  ...
  },
  {
    ...
    description: "IImprovement of MDS – Market data server, writing web and desktop apps for internal usage.",
    techStack: "Frontend - React. TSX, MobX, HTML, CSS, Webpack 2, Jasmine, Karma\n" +
  ...
  },
  {
    ...
    techStack: "ASP.NET MVC ElasticSearch, MongoDB, Redis,\n" +
  ...
  },
  {
    ...
    description: "Developing of biggest Polish price comparison website",
    techStack: "(Developing Agresso, an ERP system with C# .NET, TopGen and SQL server,\n" +
      "NUnit, Rhino Mocks 80% test coverage)\n"
  },
  {
    placeWithDate: "Volvo IT",
    jobTitle: "Internship (06.2014-09.2014)",
    description: "Developing internal application for bus technical condition analysis.",
