...
export const CvData: IWorkUnit[] = [
  ...
  },
  {
    ...
    devops: {
      description: 'Running builds + pipeline configuration',
      techStack:
        'TFS (Repos, Boards, Test Plans, self hosted, release management)',
    },
    backend: {
      description: 'Rest API Creation and integration + reading MQ',
      techStack:
  ...
  },
  {
    ...
    frontend: {
      description: 'Implementation of business requirements - creating and maintaining Angular pages.',
    ...
    backend: {
      description: 'Integration with 3rd party clients REST /MQ, exposing REST API to internal external clients.',
      techStack:
  ...
  },
  {
    ...
    frontend: {
      description: 'Development and maintenance of the REACT components',
    ...
    // },
    backend: {
      description: 'Exposing REST endpoints for FE, report generation, stored procedure optimization',
      techStack:
        '.NET core 2, ElasticSearch, Postgresql, NUnit, AWS, ActiveMQ, NAnt, Pentaho',
    },
  },
  {
    ...
    frontend: {
      description: 'Internal UI development for MDS cache management',
    ...
    // },
    backend: {
      description: 'Creation of search engines, exposing endpoints for MDS cache management (CRUD), ' +
          'query optimization',
      techStack:
  ...
  },
  {
    ...
    frontend: {
      description: 'Modifying exesting components and adding new to ceneo.pl',
    ...
    backend: {
      description: 'optimization of stored precludes, reading data from external services, report generation',
      techStack:
  ...
  },
  {
    ...
    frontend: {
      description: 'Adding business features to existing pages',
      techStack: 'Ext JS, javascript, HTML, CSS',
    },
    devops: {
      description: '',
      techStack: '',
    ...
    backend: {
      description: 'Exposing data to REST endpoints. ',
  ...
  },
  {
    ...
    frontend: {
      description: 'Creation of GUI for XML data management (information about buses)',
    ...
    backend: {
      description: 'Exposing XML data about buses to external services.',
